...
export async function POST(request: Request) {
  try {
    ...
    // Oficjalny algorytm sumy kontrolnej SHA256 dla Autopay (BlueMedia) 
    // Standardowy ciąg: pos_id | order_id | amount | description | crc
    const hashString = `${posId}|${orderId}|${amountStr}|${desc}|${crcKey}`;
